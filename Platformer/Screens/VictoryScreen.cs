...
{
    internal class VictoryScreen: BasicMenuScreen
    {
        public VictoryScreen() 
        {
            backgroundTexture = ContentManager.Instance().VictoryBackgroundTexture;
            title = ContentManager.Instance().Victory;
            ...
            MediaPlayer.Play(ContentManager.Instance().VictorySoundtrack);
